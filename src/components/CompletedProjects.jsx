  ...
  const projects = [
    {
      ...
      description: "A modern house with exquisite interior and exterior design, completed in 2023.",
      images: [
    ...
    },
    {
      ...
      description: "Renovation of a 10-year-old apartment, transforming it into a contemporary living space.",
      images: [
    ...
    },
    {
      ...
      description: "Design and construction of a multi-story commercial building completed in record time.",
      images: [
  ...
  return (
    <div className="bg-gray-50 text-gray-800 py-4">
      <div className="h-40 bg-black flex justify-center items-center mb-6">
        <h1 className="text-4xl font-bold text-white text-center mb-8">Completed Projects</h1>
      </div>
              ...
              <div className="relative">
                {project.images.map((image, index) => (
                  <img
                    ...
                    className={`w-full h-48 object-cover ${index === 0 ? "" : "hidden"}`}
                  />
                ))}
              </div>
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  {project.images.map((image, index) => (
                    <button
                      key={index}
                      onClick={() => {
                        const images = document.querySelectorAll(`#project-${project.id} img`);
